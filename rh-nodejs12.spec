...
#!/bin/sh
echo 'nodejs12-nodejs(abi) = %nodejs_abi'
echo 'nodejs12-nodejs(v8-abi) = %v8_abi'
EOF
...
%changelog
* Wed Aug 14 2019 Zuzana Svetlikova <zsvetlik@redhat.com> - 3.4-1
- Update to v12.x
